            ...
            <DropdownMenu>
              <div className="flex items-center border-b">
                ...
                <DropdownMenuTrigger asChild>
                  <Button 
                    variant="ghost" 
                    className="flex-1 justify-between hover:bg-transparent py-4 px-2 h-auto" 
              ...
              <DropdownMenuContent className="w-full" style={{ width: 'calc(100% - 2rem)', maxWidth: 'none', margin: '0 1rem' }}>
                <div className="p-4">
                  <CourseTable

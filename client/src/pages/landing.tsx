...
export default function Landing() {
  ...
  return (
    <Layout>
      ...
      {/* Context menu for image management */}
      <ContextMenu>
        <ContextMenuTrigger className="fixed bottom-4 right-4 w-10 h-10 rounded-full bg-primary/90 text-primary-foreground shadow-lg hover:bg-primary transition-all duration-300 flex items-center justify-center">

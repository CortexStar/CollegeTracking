...
export default function GradesPage() {
  ...
  return (
    <div className="container py-6 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-6 pb-2 border-b-2 border-border inline-block">Grades Summary</h1>
      ...
      <div className="space-y-4 mt-10">
        <div className="flex justify-between items-end mb-6">
          <h2 className="text-3xl font-bold pb-2 border-b-2 border-border inline-block">Semesters</h2>
          <Button size="sm" variant="outline" onClick={() => setIsDialogOpen(true)} className="mb-2">Add Semester</Button>
        </div>
